...
CrudHandler crudHandler(
    ...
    // semua query menggunakan sql (native) atau hql (hibernate)
...
class CrudController extends net.ideahut.springboot.crud.WebMvcCrudController {
    ...
    public List<Result> bulkList(HttpServletRequest httpRequest) throws Exception {
		byte[] data = WebMvcHelper.getBodyAsBytes(httpRequest);
		return super.bulkList(data);
	}

    @PostMapping(value = "/bulk/map")
	public Map<String, Result> bulkMap(HttpServletRequest httpRequest) throws Exception {
		byte[] data = WebMvcHelper.getBodyAsBytes(httpRequest);
...
class CrudController extends net.ideahut.springboot.crud.WebFluxCrudController {
    ...
    @PostMapping(value = "/bulk/list")
	public Mono<List<Result>> bulkList(ServerHttpRequest httpRequest) {
		return WebFluxHelper
		.onRequestBody(httpRequest)
		.flatMap(bytes -> {
    ...
    @PostMapping(value = "/bulk/map")
	public Mono<Map<String, Result>> bulkList(ServerHttpRequest httpRequest) {
		return WebFluxHelper
		.onRequestBody(httpRequest)
		.flatMap(bytes -> {
